...
app.get('/barnes-lee',(req,res) => res.sendFile(path.resolve(__dirname, 'views','barnes-lee.html')))


app.listen(port,() => console.log(`Se levanto con exito el servidor en http://www.localhost:${port}`))
